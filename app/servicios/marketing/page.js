              ...
              <div className="grid md:grid-cols-3 gap-8">
                {t.marketing.plans.map((plan, index) => (
                  <motion.div
                    ...
                    className={`bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden relative ${plan.highlight ? "border-2 border-[#a855f7]" : ""}`}
                  >
                    {plan.highlight && (
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-4">
                        ...
                        {plan.period && <span className="text-gray-700 dark:text-gray-300">/{plan.period}</span>}
                      </div>
                      ...
                      {plan.note && <p className="text-xs text-gray-600 dark:text-gray-400 mb-6">{plan.note}</p>}
                      <Link
                        href="/contacto"
